#############################################################################
# Makefile for building: Symmetry
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  symmetry_source/Symmetry.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ -o Makefile symmetry_source/Symmetry.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++0x -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -Wall -W -fPIC $(DEFINES)
INCPATH       = -Isymmetry_source -I. -isystem /usr/include/openbabel-2.0 -I/usr/lib/qt/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Symmetry1.0.0
DISTDIR = /home/klniu/sync/code/klniu.md/.tmp/Symmetry1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro
LIBS          = $(SUBLIBS) -lopenbabel 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = symmetry_source/main.cpp \
		symmetry_source/mapperfunctor.cpp \
		symmetry_source/symmetry.cpp 
OBJECTS       = main.o \
		mapperfunctor.o \
		symmetry.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		symmetry_source/symmetry_source/Symmetry.pro mapperfunctor.h \
		symmetry.h symmetry_source/main.cpp \
		symmetry_source/mapperfunctor.cpp \
		symmetry_source/symmetry.cpp
QMAKE_TARGET  = Symmetry
...
Makefile: symmetry_source/Symmetry.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		symmetry_source/Symmetry.pro
	$(QMAKE) -spec linux-g++ -o Makefile symmetry_source/Symmetry.pro
...
main.o: symmetry_source/main.cpp symmetry_source/symmetry.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o symmetry_source/main.cpp

mapperfunctor.o: symmetry_source/mapperfunctor.cpp symmetry_source/mapperfunctor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mapperfunctor.o symmetry_source/mapperfunctor.cpp

symmetry.o: symmetry_source/symmetry.cpp symmetry_source/symmetry.h \
		symmetry_source/mapperfunctor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o symmetry.o symmetry_source/symmetry.cpp
